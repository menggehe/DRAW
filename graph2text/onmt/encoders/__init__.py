...
from onmt.encoders.transformer import CGELWEncoder_match
...
str2enc2 = {"rnn": RNNEncoder, "brnn": RNNEncoder, "cnn": CNNEncoder,
           "cge": CGEEncoder, "cge-lw": CGELWEncoder_match, "pge": PGEEncoder,
           "pge-lw": PGELWEncoder, "img": ImageEncoder,
           "audio": AudioEncoder, "mean": MeanEncoder}
