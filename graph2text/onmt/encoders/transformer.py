...
class CGELWEncoder_match(EncoderBase):
    def __init__(self, num_layers, d_model, d_dec, number_edge_types, heads, d_ff, dropout,
                 attention_dropout, embeddings, max_relative_positions):
        super(CGELWEncoder_match, self).__init__()
        ...
        self.rnn = nn.GRUCell(self.gnn_dim, self.gnn_dim)
        self.FC = nn.Linear(self.decoder_dim, 1)
        self.FC2 = nn.Linear(self.decoder_dim, self.decoder_dim)
